target("2.3.2", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/3.2.*light*.vs")
		os.tryrm("$(projectdir)/package/shaders/3.2.*light*.fs")
		os.tryrm("$(projectdir)/package/shaders/3.2.materials.vs")
		os.tryrm("$(projectdir)/package/shaders/3.2.materials.fs")
	end)
end)
