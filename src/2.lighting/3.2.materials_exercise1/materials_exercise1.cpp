...
int main()
{
    ...
    // ------------------------------------
    utils::Shader lightingShader("3.2.materials.vs", "3.2.materials.fs");
    utils::Shader lightCubeShader("3.2.light_cube.vs", "3.2.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3(
            "light.ambient", 1.0f, 1.0f,
            1.0f); // note that all light colors are set at full intensity
