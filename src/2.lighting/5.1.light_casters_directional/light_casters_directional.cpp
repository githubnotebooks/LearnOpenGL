...
int main()
{
    ...
    // -------------------------
    utils::Shader lightingShader("5.1.light_casters.vs", "5.1.light_casters.fs");
    utils::Shader lightCubeShader("5.1.light_cube.vs", "5.1.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // a lamp object is weird when we only have a directional light, don't render the
