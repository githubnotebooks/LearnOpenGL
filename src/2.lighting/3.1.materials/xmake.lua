target("2.3.1", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/3.1.*light*.vs")
		os.tryrm("$(projectdir)/package/shaders/3.1.*light*.fs")
		os.tryrm("$(projectdir)/package/shaders/3.1.materials.vs")
		os.tryrm("$(projectdir)/package/shaders/3.1.materials.fs")
	end)
end)
