target("1.3.6", function()
	...
	on_config(function(target)
		...
		if not os.exists(main_file) then
			...
			content = content:gsub('"3.3.shader.vs"', '"shaders_exercise3.vs"')
			content = content:gsub('"3.3.shader.fs"', '"shaders_exercise3.fs"')
	...
	after_clean(function(target)
		...
		os.tryrm("$(projectdir)/package/shaders/shaders_exercise3.vs")
		os.tryrm("$(projectdir)/package/shaders/shaders_exercise3.fs")
	end)
end)
