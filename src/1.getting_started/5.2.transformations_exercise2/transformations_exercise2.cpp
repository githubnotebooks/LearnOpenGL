...
int main()
{
    ...
    // ------------------------------------
    utils::Shader ourShader("5.2.transform.vs", "5.2.transform.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE,
                           &transform[0][0]); // this time take the matrix value array's
                                              // first element as its memory pointer value

        // now with the uniform matrix being replaced with new transformations, draw it
        // again.
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
