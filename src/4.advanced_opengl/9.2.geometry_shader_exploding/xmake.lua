target("4.9.2", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/9.2.geo*.vs")
		os.tryrm("$(projectdir)/package/shaders/9.2.geo*.gs")
		os.tryrm("$(projectdir)/package/shaders/9.2.geo*.fs")
	end)
end)
