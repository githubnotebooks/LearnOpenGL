target("4.9.1", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/9.1.geo*.vs")
		os.tryrm("$(projectdir)/package/shaders/9.1.geo*.gs")
		os.tryrm("$(projectdir)/package/shaders/9.1.geo*.fs")
	end)
end)
