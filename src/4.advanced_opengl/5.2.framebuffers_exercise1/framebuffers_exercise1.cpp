...
int main()
{
    ...
    float quadVertices[] = {
        ...
        // Coordinates. NOTE that this plane is now much smaller and at the top of the
        // screen
        // positions   // texCoords
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        camera.ProcessMouseMovement(
            0, 0, false); // call this to make sure it updates its camera vectors, note
                          // that we disable pitch constrains for this specific case
