...
int main()
{
    ...
    // -------------------------
    utils::Shader shader("5.1.framebuffers.vs", "5.1.framebuffers.fs");
    utils::Shader screenShader("5.1.framebuffers_screen.vs", "5.1.framebuffers_screen.fs");
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, SCR_WIDTH,
                          SCR_HEIGHT); // use a single renderbuffer object for both a
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // now bind back to default framebuffer and draw a quad plane with the attached
        ...
        glBindTexture(GL_TEXTURE_2D,
                      textureColorbuffer); // use the color attachment texture as the
