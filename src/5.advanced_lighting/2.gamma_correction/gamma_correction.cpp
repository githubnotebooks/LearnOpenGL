...
int main()
{
    ...
    // -------------------------
    utils::Shader shader("2.gamma_correction.vs", "2.gamma_correction.fs");
    ...
    unsigned int floorTexture =
        loadTexture(utils::FileSystem::getPath("resources/textures/wood.png").c_str(), false);
    unsigned int floorTextureGammaCorrected =
        loadTexture(utils::FileSystem::getPath("resources/textures/wood.png").c_str(), true);
    ...
    glm::vec3 lightColors[] = {glm::vec3(0.25), glm::vec3(0.50), glm::vec3(0.75),
                               glm::vec3(1.00)};
