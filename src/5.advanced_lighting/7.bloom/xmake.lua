target("5.7", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/7.bloom*.vs")
		os.tryrm("$(projectdir)/package/shaders/7.bloom*.fs")
		os.tryrm("$(projectdir)/package/shaders/7.blur.vs")
		os.tryrm("$(projectdir)/package/shaders/7.blur.fs")
		os.tryrm("$(projectdir)/package/shaders/7.light_box.fs")
	end)
end)
