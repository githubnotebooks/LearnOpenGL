...
int main()
{
    ...
    // -------------------------
    utils::Shader shader("3.1.3.shadow_mapping.vs", "3.1.3.shadow_mapping.fs");
    utils::Shader simpleDepthShader("3.1.3.shadow_mapping_depth.vs",
                             "3.1.3.shadow_mapping_depth.fs");
    utils::Shader debugDepthQuad("3.1.3.debug_quad.vs", "3.1.3.debug_quad_depth.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // (GLfloat)SHADOW_HEIGHT, near_plane, far_plane); // note that if you use a
