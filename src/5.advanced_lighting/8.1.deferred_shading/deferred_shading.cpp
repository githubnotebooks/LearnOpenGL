...
int main()
{
    ...
    // -------------------------
    utils::Shader shaderGeometryPass("8.1.g_buffer.vs", "8.1.g_buffer.fs");
    utils::Shader shaderLightingPass("8.1.deferred_shading.vs", "8.1.deferred_shading.fs");
    utils::Shader shaderLightBox("8.1.deferred_light_box.vs", "8.1.deferred_light_box.fs");
