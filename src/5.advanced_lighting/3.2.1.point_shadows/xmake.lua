target("5.3.2.1", function()
	...
	after_clean(function(target)
		os.tryrm("$(projectdir)/package/shaders/3.2.1.*.vs")
		os.tryrm("$(projectdir)/package/shaders/3.2.1.*.fs")
		os.tryrm("$(projectdir)/package/shaders/3.2.1.*.gs")
	end)
end)
