...
int main()
{
    ...
    glDepthFunc(
        GL_LEQUAL); // set depth function to less than AND equal for skybox depth trick.

    // build and compile shaders
    // -------------------------
    utils::Shader pbrShader("2.1.2.pbr.vs", "2.1.2.pbr.fs");
    utils::Shader equirectangularToCubemapShader("2.1.2.cubemap.vs",
                                          "2.1.2.equirectangular_to_cubemap.fs");
    utils::Shader irradianceShader("2.1.2.cubemap.vs", "2.1.2.irradiance_convolution.fs");
    utils::Shader backgroundShader("2.1.2.background.vs", "2.1.2.background.fs");
